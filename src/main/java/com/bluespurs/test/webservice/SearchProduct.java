package com.bluespurs.test.webservice;

import com.bluespurs.test.bean.Product;
import com.bluespurs.test.exception.CatchRestException;
import com.bluespurs.test.exception.ValidationException;
import com.bluespurs.test.service.ProductComparatorService;
...
public class SearchProduct {
     ...
     *
     * 
     * @param name : keyword to search product by name
     ...
     * @throws com.bluespurs.test.exception.ValidationException
     */
    @GET
    @Path("/search")
    @Produces(MediaType.APPLICATION_JSON)
